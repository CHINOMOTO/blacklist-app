      ...
      <div className="min-h-screen pt-24 pb-12 px-4 flex flex-col items-center">
        <div className="max-w-4xl w-full relative z-10">
          ...
          <div className="flex items-center justify-between mb-8 animate-fade-in">
            <div>
              <h1 className="text-4xl font-bold text-white mb-2 tracking-tight">謇ｿ隱榊ｾ・■荳隕ｧ</h1>
              <p className="text-[#00e5ff] font-medium">遒ｺ隱阪′蠢・ｦ√↑逕ｳ隲九・荳隕ｧ縺ｧ縺・/p>
            </div>
          ...
          {loading ? (
            ...
            <div className="glass-panel p-12 text-center rounded-3xl border-white/5 bg-slate-900/30 animate-fade-in">
              <div className="text-4xl mb-4 opacity-30">笨・/div>
              <p className="text-slate-400 font-medium">迴ｾ蝨ｨ縲∝ｯｩ譟ｻ荳ｭ縺ｮ譯井ｻｶ縺ｯ縺ゅｊ縺ｾ縺帙ｓ縲・/p>
              <p className="text-slate-500 text-sm mt-2">蜈ｨ縺ｦ縺ｮ逕ｳ隲九′蜃ｦ逅・＆繧後∪縺励◆縲・/p>
            </div>
          ) : (
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <div className="flex gap-4 text-sm text-slate-400 mt-1">
                        <span className="font-mono">逕溷ｹｴ譛域律: {c.birth_date ? c.birth_date.replace(/-/g, "/") : "荳肴・"}</span>
                      </div>
                    </div>
                  </div>

                  <div className="text-right">
                    <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">逕ｳ隲区律</span>
