...
export default function RootLayout({
  ...
  return (
    <html lang="ja">
      ...
      <body className="font-sans antialiased bg-slate-800 text-scouter-green overflow-x-hidden min-h-screen selection:bg-scouter-green selection:text-slate-900">
