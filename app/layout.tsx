...
export default function RootLayout({
  ...
  return (
    <html lang="ja">
      ...
      <body className="font-sans antialiased bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-800 via-slate-900 to-black text-scouter-green overflow-x-hidden min-h-screen selection:bg-scouter-green selection:text-slate-900">
