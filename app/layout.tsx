  ...
  return (
    <html lang="ja">
      ...
      <body className="font-sans antialiased bg-black text-scouter-green overflow-x-hidden min-h-screen selection:bg-scouter-green selection:text-black">
        <div className="fixed inset-0 pointer-events-none z-0 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(0,229,255,0.06)_1px,transparent_0),linear-gradient(rgba(0,229,255,0.06)_1px,transparent_0)] bg-[length:100%_2px,20px_20px,20px_20px]"></div>
